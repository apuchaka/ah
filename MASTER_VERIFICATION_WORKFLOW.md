...
| N7 | Sexual Health/STIs depth-confirmation pass (`08_08`, `17_07`) | ⬜ **never started** — was listed only in the lower new-content table and not in this queue, so "next" never reached it. Added here 2026-08-28. |
