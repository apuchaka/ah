...
> - **Adding ICS (escalating to triple therapy):** guided by blood eosinophil count — a higher eosinophil count predicts a better ICS response. Patients with persistent exacerbations on dual LAMA/LABA therapy and a higher eosinophil count are more likely to benefit from stepping up to ICS/LABA/LAMA triple therapy; ICS is not simply added because of a background asthma/atopy history the way the "asthmatic features" checklist below implies.
