...
> 2. **Level 2:** Low-dose MART (maintenance treatment with low-dose ICS-formoterol, plus extra as-needed doses from the same inhaler)
...
>
> Only formoterol-containing ICS combinations (budesonide-formoterol or beclometasone-formoterol) are approved for use as a reliever (AIR/MART) — this is a specific pharmacological requirement (formoterol's fast onset), not interchangeable with other LABAs. Some patients still use and benefit from other ICS/ICS-LABA devices with SABA as the reliever — an alternative pathway still described in the Australian Asthma Handbook for patients established on and doing well with that approach.
>
