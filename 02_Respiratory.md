...
**A/P:** Two components — (1) inflammation, (2) airway hyper-responsiveness (AHR). Large airways and small airways (<2µm) are the sites of inflammation and obstruction.
1. Inflammation: initial trigger → Th2 response + other inflammatory cells migrate to airway epithelium and cause change
2. AHR: smooth muscle contraction; baseline fixed component (airway remodelling) + episodic variable component (acute inflammation)

**S/Smx:** recurrent dyspnoea, chest tightness, wheezing, coughing; triggered by allergens; night-time symptoms that wake the patient in severe asthma. In exacerbation, wheezing is audible; chest may be silent if severe.

> [!info] Diagnosis by age
> - **≥17yo:** spirometry (*why:* confirms obstruction and its reversibility — the core diagnostic feature; *what:* see spirometry pattern below) & bronchodilator reversibility (BDR) + FeNO (*why:* FeNO is a marker of eosinophilic airway inflammation, supporting an asthma diagnosis particularly when spirometry is equivocal; *what:* >40 ppm supports the diagnosis)
> - **5–16yo:** spirometry & BDR + FeNO >35 ppm (if normal spirometry or obstructive symptoms and negative BDR test)
> - **<5yo:** diagnosis on clinical judgment alone (*why:* young children usually cannot reliably perform spirometry; *what:* based on symptom pattern and response to a bronchodilator trial)
> - Reversibility testing: positive if FEV1 increase **≥12% *and* ≥200 mL** — see the box below, which corrects an **or** that stood here
> - Peak flow variability: ask if symptoms improve on holidays / away from work (*why:* screens for an occupational/environmental trigger; *what:* symptom improvement away from a suspected trigger supports it as causative)

> [!danger] **This line read "≥12% *or* ≥200 mL". The conventional criterion requires BOTH, not either.**
> Read as **or**, a 200 mL rise alone counts as reversible however small a fraction of baseline it is, and a 12% rise alone counts however tiny the absolute volume — so the criterion becomes far looser than intended and calls tests positive that are not. Corrected to **and**. The corpus stated this criterion **both ways in two different files**: `02_Respiratory` (here) said *or*, while [[NEW_Investigations_Respiratory]] 0.2 said *and*. Found by the corpus-wide adult-vs-paediatric sweep, 2026-08-30; see `PENDING_GUIDELINE_CHECKS.md` **B68**.
> **The threshold itself is disputed and is not settled here.** The 2022 ATS/ERS interpretation update replaced the ≥12%-and-200 mL rule with a change of **>10% of the predicted value**, on the grounds that a percentage-of-baseline threshold is biased against patients with low baseline values. Both are in current use. [[NEW_Investigations_Respiratory]] 0.2 sets out the conflict in full; read which definition your laboratory's report applies.
> **And note where this sits: the two rows immediately above are the 5–16yo and <5yo diagnostic pathways.** The **≥200 mL** component is an **adult** absolute — a child's entire FEV₁ may be little more than a litre, so a fixed 200 mL requirement is a far larger relative change in a child and will under-diagnose reversibility in small lungs. Paediatric spirometry is read against age-, height- and sex-specific predicted values.

> [!info] Verified against the Australian Asthma Handbook (National Asthma Council), 2025 edition — Aug 2026. Australia has moved to essentially the same AIR/MART-based approach as the UK's 2024 NICE/BTS/SIGN guidance (both now reflect GINA international consensus), but with Australia's own "Treatment Level" numbering — use the AU terminology below, not the NICE step numbers.
> **Mx in individuals ≥12yo (Australian Asthma Handbook treatment levels):**
> 1. **Level 1:** Low-dose budesonide-formoterol taken as needed (anti-inflammatory reliever, AIR-only) — first-line for newly-diagnosed mild disease; replaces SABA-alone as the reliever, since SABA-only is now considered inadequate treatment in adults/adolescents (ICS is recommended for all patients with asthma, not just those with frequent symptoms)
> 2. **Level 2:** Low-dose **MART — Maintenance And Reliever Therapy** (maintenance treatment with low-dose ICS-formoterol, plus extra as-needed doses from the same inhaler)
> 3. **Level 3:** Medium-dose MART
> 4. **Level 4:** targeted intensive treatment — more intensive ICS-LABA-based regimens, sometimes with add-on LAMA or biologic (monoclonal antibody) therapy for severe asthma
>
> Only formoterol-containing ICS combinations (budesonide-formoterol or beclometasone-formoterol) are approved for use as a reliever (AIR/MART) — this is a specific pharmacological requirement, not interchangeable with other LABAs. *Why formoterol specifically:* it is the only LABA with **both** a fast onset (minutes, like a SABA — so it works as a reliever) **and** a long duration (~12 hours — so the same dose also does the maintenance job). Salmeterol has the duration but not the onset, so it cannot be used as a reliever; a SABA has the onset but no anti-inflammatory component at all. Combining fast onset with an inhaled corticosteroid in one device is the whole point of the approach: every reliever dose also delivers preventer. Some patients still use and benefit from other ICS/ICS-LABA devices with SABA as the reliever — an alternative pathway still described in the Australian Asthma Handbook for patients established on and doing well with that approach.
>
> **Mx in individuals 5–12yo:** the Australian Asthma Handbook's 2025 update also revised paediatric asthma diagnosis/management — check the current Handbook directly for the paediatric stepwise regimen rather than relying on the UK 5–12yo steps here, as this wasn't individually re-verified this session.

**Monitoring:** daily PEFR readings.

> [!info] Spirometry pattern in asthma
> FEV1 ↓↓↓, FVC normal, FEV1/FVC <70% — ❗ REVERSIBLE (distinguishes from COPD)

### Acute exacerbation

> [!info] Verified against the Australian Asthma Handbook (National Asthma Council), Aug 2026 — Australia uses its own severity classification (mild/moderate/severe/life-threatening) rather than the "BTS" framework; broadly similar in spirit but don't cite it as "BTS" in an AU context. Full criteria are more detailed than reproduced here (based on speech, accessory muscle use, conscious state, SpO2, and — for life-threatening — signs of exhaustion/hypercapnoea) — check the current Handbook table for the complete grid if precise cut-offs are needed.
> Broad guide: **Moderate** — able to speak in sentences, no cyanosis, SpO2 ≥92%. **Severe** — unable to complete sentences in one breath, using accessory muscles, marked tachycardia. **Life-threatening** — exhaustion, confusion/reduced consciousness, cyanosis, poor respiratory effort, SpO2 <90%, silent chest, bradycardia/dysrhythmia — hypercapnoea especially is an ominous sign indicating the patient is tiring.

**S/Smx (moderate–severe):** SOB, cough, wheeze, ↑chest tightness, ↓PFT, ↑HR, ↑RR, accessory muscle use, sleep disturbance.

> [!danger] Silent chest = impending respiratory failure.

**Ix:** ABG (*why:* assesses oxygenation/ventilation and specifically screens for hypercapnoea, a marker of a tiring patient needing escalation; repeat within ~1h if ongoing concern; *what:* hypoxia ± initially normal or low CO2 [from hyperventilation] — a "normalising" or rising CO2 in a tachypnoeic patient is a red flag for exhaustion/impending failure, not reassurance). Peak flow (*why:* quantifies severity and objectively tracks response to treatment; *what:* reduced from personal best/predicted, reassessed 15–30 min after starting treatment to gauge response). O2 sats (*why:* continuous, non-invasive severity/response marker; *what:* reduced in severe/life-threatening disease — see severity grid above). CXR (*why:* not routine — reserved for suspected complications (pneumothorax) or failure to respond, since it rarely changes acute Mx; *what:* usually normal in uncomplicated asthma).

> [!info] Verified against the Australian Asthma Handbook, Aug 2026 — Australian oxygen target and steroid dosing differ from generic UK figures; use these AU-specific values.
> **Target SpO2 92–96%** while treating (titrate down once improving) — note COPD-overlap/chronic hypercapnoeic-risk patients instead target 88–92% (as for COPD, see below).
> **Corticosteroids:** oral prednisone/prednisolone 37.5–50mg, repeated each morning for a total of 5–10 days (alternative: oral dexamethasone 16mg for 2 days then cease) — indicated for all severe/life-threatening exacerbations, and considered case-by-case for mild-moderate.

**Mx:**
- **Immediate/acute:** O2 (target as above), SABA (short-acting beta-2 agonist; inhaled/IV — salbutamol via nebuliser or spacer), oral/IV corticosteroid (dosing above), ipratropium bromide nebulisers for severe/life-threatening disease, ± IV MgSO4 for severe exacerbations not responding well to initial bronchodilator, or life-threatening disease; IV aminophylline as a further option in life-threatening/refractory cases (specialist/ICU input); intubate & ventilate + ICU if not responding.
- **Definitive/chronic:** once stabilised, step up preventer therapy per the treatment-level framework above and provide/update a written asthma action plan — an exacerbation requiring oral corticosteroids is itself a trigger to review and intensify maintenance treatment, not just treat the acute episode in isolation.

> [!tip] Mnemonic "CRAB": Chronic, Reversible obstruction, Airway hypersensitivity, Bronchial inflammation

---

## COPD

**D:** Disease state characterised by progressive airflow limitation that is not fully reversible. Encompasses both emphysema and chronic bronchitis.

**R:** ❗ smoking, ↑age, genetics (alpha-1 antitrypsin deficiency), childhood lung issues

> [!danger] A genuine, severe Australian health equity issue with a genuinely important diagnostic overlap point — not a generic epidemiological footnote. **COPD is substantially more common, more severe, and develops earlier in Aboriginal and Torres Strait Islander Australians**: AIHW data show self-reported prevalence roughly 2.5 times higher, hospitalisation rates **5 times higher**, and mortality **nearly 3 times higher** than non-Indigenous Australians — and these diseases genuinely "develop at younger ages and progress faster" in this population, not just occur more often at the same ages. Daily smoking prevalence (a major driver) is roughly double that in non-Indigenous Australians, though it has been falling over time (51%→44% between 2001 and 2012–13).
> - **A genuinely important diagnostic point, directly connecting to bronchiectasis** (see [[02_Respiratory]] Bronchiectasis, not repeated in full here — including its own severe, distinct Indigenous Australian burden already established there): a Northern Territory cohort study found bronchiectasis is **co-diagnosed in around half of Aboriginal patients with COPD** — a much higher overlap than expected in general-population COPD. **This means COPD and bronchiectasis should be actively considered together, not treated as competing/mutually exclusive differentials, in an Aboriginal or Torres Strait Islander patient presenting with chronic airflow obstruction** — the presence of one shouldn't lower suspicion for the other, and each carries implications for the other's management (e.g. bronchiectasis-directed airway clearance alongside standard COPD management).
> - **Practical implication**: given the disease develops earlier and progresses faster, a lower threshold for spirometry-based case-finding and earlier smoking-cessation intervention in this population is genuinely warranted, rather than applying general-population age-based screening assumptions.

**A/P:** chronic inflammation affecting central and peripheral airways, lung parenchyma and alveoli, and pulmonary vasculature. Repeated injury and repair → structural and physiological changes:
- Narrowing and remodelling of airways
- ↑ number of goblet cells; ↑ size of mucus-secreting glands of central airways
- Alveolar loss
- Vascular bed changes → pulmonary hypertension

Emphysema occurs due to elastin breakdown causing loss of alveolar integrity.

**S/Smx:** cough (morning cough progressing to constant), SOB, sputum ± barrel chest, hyper-resonance, wheezing ("continuous musical lung sound"), coarse crackles

> [!info] Fixed obstructive pattern
> FEV1/FVC ratio <70% (fixed, unlike the reversible pattern in asthma)

**Ix:** spirometry (*why:* diagnostic — confirms fixed airflow obstruction; *what:* FEV1/FVC <0.7, not significantly reversible unlike asthma; FEV6 also acceptable where FVC is hard to obtain reliably). mMRC dyspnoea scale (*why:* quantifies functional impact and guides Mx intensity/pulmonary rehab referral; *what:* graded 1–5, see below). O2 sats (*why:* screens for resting hypoxaemia, relevant to LTOT eligibility; *what:* may be reduced in more severe disease). ABG (*why:* assesses for chronic CO2 retention, relevant to safe O2 prescribing and LTOT assessment; *what:* may show compensated respiratory acidosis in chronic retainers). CXR (*why:* screens for hyperinflation and excludes alternative/coexisting pathology, especially lung cancer given the shared smoking risk factor; *what:* hyperinflation, flattened diaphragms, or may be normal). FBC (*why:* screens for secondary polycythaemia from chronic hypoxia, and anaemia/infection as alternative dyspnoea contributors; *what:* may show raised Hb/Hct in longstanding hypoxic COPD). ECG (*why:* comorbidity assessment, screens for cor pulmonale/right heart strain and coexisting cardiac disease given shared risk factors; *what:* may show right axis deviation, P pulmonale). Alpha-1-antitrypsin levels (*why:* screens for this genetic cause, especially relevant in younger patients or non-smokers with COPD; *what:* low level supports the diagnosis). Exercise testing (*why:* objectively quantifies functional capacity and desaturation, guiding O2/rehab decisions; *what:* may reveal exertional desaturation). Sputum culture (*why:* identifies chronic colonising organisms relevant to exacerbation management; *what:* may grow typical exacerbation pathogens even outside acute exacerbation in colonised patients).

> [!info] GOLD staging (based on %FEV1 of predicted)
> \>80% — Stage 1 (mild) | 50–79% — Stage 2 (moderate) | 30–49% — Stage 3 (severe) | <30% — Stage 4 (very severe)

**Complications:** cor pulmonale (engorged neck veins, oedema, hepatomegaly — treat with long-term oxygen therapy, LTOT), increased risk of recurrent pneumonia and depression. Variable disease course; prognosis may be estimated using FEV1.

### Clinical phenotypes
- **Blue bloaters (chronic bronchitis):** productive cough, frequent respiratory tract infections, progressive cardiorespiratory failure with oedema and weight gain → obese, accessory muscle use, coarse rhonchi
- **Pink puffers (emphysema):** long history of progressive SOB, late-onset non-productive cough, occasional respiratory infections, eventual cachexia and respiratory failure → thin/barrel-shaped chest, pursed lips, tripod positioning, hyper-resonant chest, distant heart sounds

> [!info] MRC Dyspnoea Scale
> 1 — SOB on strenuous exercise | 2 — SOB walking up a hill | 3 — SOB that slows walking on flat ground | 4 — SOB after 100m on the flat | 5 — unable to leave the house due to SOB

### Mx of stable COPD

> [!info] Verified against the COPD-X Plan (Lung Foundation Australia / Thoracic Society of Australia and New Zealand), current version Dec 2025, Aug 2026 — Australia uses essentially the same drug classes and many of the same combination products (Trelegy, Trimbow, Breztri all TGA-approved/PBS-available in Australia), but the stepwise logic differs from the UK's "asthmatic features" framework below. COPD-X instead uses a symptom/exacerbation-risk-based initial choice (similar to GOLD ABE groups) plus **blood eosinophil count** to guide whether/when to add ICS — not a checklist of asthma-like features.
> - **Initial therapy:** LAMA (preferred) or LABA monotherapy for less symptomatic/lower exacerbation-risk patients; LAMA+LABA dual bronchodilator therapy for more symptomatic patients or higher exacerbation risk.
> - **Adding ICS (inhaled corticosteroid; escalating to triple therapy):** guided by blood eosinophil count — a higher eosinophil count predicts a better ICS response. Patients with persistent exacerbations on dual LAMA/LABA therapy and a higher eosinophil count are more likely to benefit from stepping up to ICS/LABA/LAMA triple therapy; ICS is not simply added because of a background asthma/atopy history the way the "asthmatic features" checklist below implies.
> - This replaces the specific "asthmatic/steroid-responsive features" checklist as the AU decision framework — don't use that checklist to decide on ICS in Australian practice; use exacerbation frequency + eosinophil count instead.

**General advice:** smoking cessation (nicotine replacement, varenicline, bupropion), annual flu vaccine, one-off pneumococcal vaccination, pulmonary rehabilitation if functional disability.

**Bronchodilator (drug classes — same classes used in Australia; see COPD-X box above for AU-specific stepwise logic):**
- SABA or SAMA (e.g. ipratropium) for initial/mild symptom relief
- LAMA (preferred) or LABA monotherapy as initial regular therapy
- LAMA + LABA dual therapy for more symptomatic/higher-risk patients
- ICS added (triple therapy) guided by exacerbation frequency + eosinophil count, per the COPD-X framework above — not by a UK-style "asthmatic features" checklist
...
| Inhaled corticosteroid | beclometasone, fluticasone, budesonide |

**Combination inhalers (TGA-approved/PBS-listed in Australia; brand names largely shared with the UK market):** Symbicort (LABA+ICS — budesonide + formoterol); Seretide (LABA+ICS — salmeterol + fluticasone); Trelegy Ellipta (ICS+LAMA+LABA — fluticasone furoate + umeclidinium + vilanterol); Trimbow (ICS+LAMA+LABA — beclometasone + glycopyrronium + formoterol); Breztri (ICS+LAMA+LABA — budesonide + glycopyrronium + formoterol); Enerzair (ICS+LAMA+LABA — mometasone + glycopyrronium + indacaterol).

> [!info] Verified against COPD-X (MJA 2022 update; Lung Foundation Australia COPD Exacerbation Algorithm), Aug 2026 — Australian dosing/duration differs from the UK figures previously here; genuinely shorter courses than the UK regimen.
> **Rescue pack (COPD Action Plan):** oral prednisolone 30–50mg once daily for **5 days** (not 7–14 days as in UK practice — up to 2 weeks' prednisolone is "adequate" per COPD-X but longer courses add no benefit and increase side-effect risk, so 5 days is the standard self-management-plan duration). Antibiotics only if signs of infection (increased sputum volume/purulence or fever) — first-line **amoxicillin or doxycycline for 5 days** (not the UK's clarithromycin option listed as equivalent — clarithromycin isn't part of the Australian first-line COPD exacerbation antibiotic choice). Target SpO2 88–92% if supplemental O2 needed (nasal prongs 0.5–2L/min usually sufficient) — consistent with the asthma/COPD chronic-hypercapnoea-risk O2 target already noted elsewhere in this file.
> - ❗ Increasing use of rescue packs indicates worsening COPD

**Step-down treatment:** trial 25–50% reduction in ICS dose, with the COPD-X eosinophil-guided approach informing whether de-escalation is appropriate (lower eosinophil counts favour successful ICS withdrawal).

### Exacerbation of COPD
**Common infections:** *H. influenzae*, *S. pneumoniae*, *M. catarrhalis*

**Ix:** ABG (*why:* distinguishes acute-on-chronic respiratory failure from acute decompensation and screens for CO2 retention guiding safe O2 therapy; *what:* should show compensated respiratory acidosis in chronic CO2 retainers — an acute uncompensated picture suggests a more acute/severe process).

> [!warning] Ensure sats 88–92% in known CO2 retainers — use a Venturi mask to give a specific %O2. If bicarbonate is normal, aim for >94% (less risk of CO2 retention). This aligns with the Thoracic Society of Australia and New Zealand's SpO2 target of 88–92% for exacerbations of COPD and other chronic-hypercapnoea-risk conditions (see the Asthma acute exacerbation section above for the same principle) — verified consistent with Australian practice.

**Mx:**
- **Immediate/acute:** prednisolone 30–50mg OD for 5 days (verified AU dosing per COPD-X — see box above); regular inhaler/nebuliser bronchodilator therapy; antibiotics only if signs/symptoms of pneumonia or a purulent-sputum exacerbation — amoxicillin or doxycycline first-line for 5 days (verified AU choice — not clarithromycin, see box above); controlled O2 therapy targeting the sats range above; consider NIV if respiratory acidosis persists despite initial treatment (see Oxygen Therapy/NIV section below).
- **Definitive:** identify and treat the precipitant (infective vs non-infective); review inhaler technique and adherence before assuming treatment failure.
- **Chronic/long-term:** post-exacerbation review of maintenance therapy (an exacerbation may itself be the trigger to step up therapy per the COPD-X framework above); pulmonary rehabilitation referral if not already engaged; ensure vaccination status is current.
...
### Small cell lung cancer (SCLC) — 15% of lung cancers
...
### Non-small cell lung cancer (NSCLC) — 80% of lung cancers
...
### Pulmonary fibrosis — zonal distribution
...
### Viral pneumonia/pneumonitis (including COVID-19)
...
### Diagnosis of latent TB — Mantoux test
...
### Mx of spontaneous pneumothorax
...
**D:** autosomal recessive disorder, ~1:2500 incidence at birth, ~1:25 carrier rate. Mutation on the CFTR gene on chromosome 7, coding for a chloride channel.

**R:** family history, ethnicity (white)

**A/P:** mutation leads to abnormal salt transportation → thick secretions.
- Pancreas: blockage of exocrine glands, eventual autodestruction of exocrine pancreas
- Intestines: bulky stools
- Respiratory: mucus retention, increased infections, inflammation, eventual lung tissue destruction

**Presenting features:**
- Neonatal period (20%): meconium ileus, prolonged jaundice
- Recurrent chest infections (40%)
- Malabsorption (30%): steatorrhoea, failure to thrive
- Others (10%): liver failure

**Other S/Smx:** short stature, diabetes mellitus, delayed puberty, rectal prolapse, nasal polyps, infertility/subfertility

**Screening in newborns:** immunoreactive trypsinogen (IRT) ± 2-stage genetic testing (~29 mutations) on the newborn blood spot test (Guthrie card).

**Dx:** sweat test positive if chloride >60 mEq/L (technically challenging test) (*why:* confirms the diagnosis in a screen-positive or clinically-suspected infant/child; *what:* elevated sweat chloride reflects the CFTR chloride-transport defect directly).

**Mx:**
- **Definitive/chronic (no separate acute tier — this is lifelong management, punctuated by exacerbations managed per the Bronchiectasis/pneumonia sections above):**
  - Regular (≥bd) chest physiotherapy and postural drainage
  - High-calorie diet (including increased fat)
  - Social distancing/cross-infection control between CF patients to reduce transmission of resistant/CF-specific pathogens (e.g. *B. cepacia*, *Pseudomonas*)
  - Vitamin supplementation (fat-soluble vitamins A, D, E, K, given pancreatic insufficiency)
  - Pancreatic enzyme replacement therapy (PERT) with meals
  - Lung transplant — chronic infection with *Burkholderia cepacia* is an important CF-specific contraindication to lung transplant

> [!info] Verified against PBS/Services Australia and Australian Government health announcements, Aug 2026 — CFTR modulator therapy has moved well beyond Orkambi alone in Australian practice; this is a significant update, not just a localisation of the existing note.
> **CFTR modulator therapy (disease-modifying, not just symptomatic) is now the mainstay for eligible genotypes and materially changes prognosis** — the source note's focus on Orkambi alone understates current practice:
> - **Orkambi (lumacaftor/ivacaftor):** PBS-listed since 2018 for patients ≥1yo homozygous for the F508del mutation.
> - **Trikafta (elexacaftor/tezacaftor/ivacaftor + ivacaftor):** the more effective, now-preferred triple-combination CFTR modulator for eligible patients — PBS-listed since April 2022 for ages ≥12yo with ≥1 F508del mutation, and progressively expanded (children 6–11yo from May 2023; ages 2–5yo from mid-2024; further expanded from July 2025 to include patients with at least one CFTR mutation responsive to treatment, even without F508del, broadening eligibility to rarer mutations). This is now the go-to modulator for most newly-eligible patients rather than Orkambi.
> - Also PBS-subsidised: ivacaftor monotherapy (for specific gating mutations), tezacaftor+ivacaftor, and a newer combination (vanzacaftor+tezacaftor+deutivacaftor) for ages ≥6yo as of early 2026.
> - These have increased CF life expectancy substantially (cited as ~47 to ~60 years over the past two decades) and represent a major shift from purely supportive/symptomatic Mx (physio, PERT, antibiotics) toward disease-modifying therapy for the majority of patients with an eligible genotype — worth knowing as current best practice, not just "Orkambi for F508del homozygotes" as the source note implied.
...
**D:** Repeated partial or complete upper airway obstruction during sleep, causing apnoeas/hypopnoeas, oxygen desaturation, and sleep fragmentation.

**R:** obesity (strongest risk factor), male sex, older age, large neck circumference, craniofacial abnormalities (retrognathia), enlarged tonsils/adenoids, alcohol/sedative use, smoking, family history, menopause (loss of the pre-menopausal protective effect).

**A/P:** collapse of the pharyngeal airway during sleep (loss of normal dilator muscle tone) → partial (hypopnoea) or complete (apnoea) obstruction → oxygen desaturation and hypercapnoea → arousal to restore airway patency → fragmented, non-restorative sleep, repeated many times per hour in moderate-severe disease.

**S/Smx:** loud snoring, witnessed apnoeas (often reported by a bed partner — collateral history is valuable), excessive daytime sleepiness, morning headache, non-restorative sleep, nocturia, reduced concentration/memory, irritability. Associated with and a risk factor for hypertension (often resistant to treatment), AF and other arrhythmias, stroke, and metabolic syndrome — screen for OSA in patients with treatment-resistant HTN or unexplained nocturnal arrhythmia.

**Ix:** clinical screening tools — *why:* identify patients warranting formal sleep study; *what:* STOP-BANG or Epworth Sleepiness Scale (subjective daytime sleepiness score) support pre-test probability. Polysomnography (sleep study) — *why:* the diagnostic gold-standard, quantifies severity; *what:* apnoea-hypopnoea index (AHI) — events per hour — defines severity (mild ~5–15, moderate ~15–30, severe >30). Home sleep apnoea testing — *why:* a more accessible alternative to in-lab polysomnography for patients with a high pre-test probability and no significant comorbidity complicating interpretation; *what:* simplified respiratory-focused monitoring, less comprehensive than full polysomnography.

**Mx:**
- **Definitive (no acute tier — this is a chronic condition managed in the outpatient setting, other than acute complications like decompensated HF from long-standing untreated severe OSA):**
  - Weight loss — a cornerstone of Mx given obesity's central role, can significantly reduce severity.
  - CPAP (continuous positive airway pressure) — first-line for moderate-severe OSA, splints the airway open; effectiveness depends heavily on adherence, which is often the main practical barrier.
  - Mandibular advancement splints — an alternative for mild-moderate OSA or CPAP-intolerant patients, worn at night to bring the mandible/tongue forward.
  - Positional therapy — for patients whose OSA is predominantly positional (worse supine).
  - Surgery (e.g. tonsillectomy/adenoidectomy in children with adenotonsillar hypertrophy, or more extensive upper airway surgery in select adults) for specific anatomical causes.
- **Chronic/long-term:** avoid alcohol/sedatives before sleep (worsen airway tone); treat nasal obstruction if contributing; address driving safety directly — untreated significant OSA with excessive daytime sleepiness has real driving-fitness implications (cross-reference Austroads-style principles as for cardiac conditions in [[01_Cardiovascular]] 0.34.5, though the specific OSA driving standard sits in the Neurological/sleep disorders chapter of Assessing Fitness to Drive, not verified in this session); manage associated cardiometabolic risk factors given the strong bidirectional relationship with hypertension, AF, and metabolic syndrome.

**P:** untreated moderate-severe OSA is associated with increased cardiovascular risk, motor vehicle accident risk (from daytime sleepiness), and reduced quality of life; CPAP adherence substantially improves symptoms and reduces cardiovascular risk, but adherence itself is the main determinant of benefit realised in practice.
...
## Pneumoconioses (Occupational Lung Disease — brief overview)
