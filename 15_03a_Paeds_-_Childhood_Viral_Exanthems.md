---
block: Paediatrics
source: quackquackmed 15.03 Childhood viral exanthems - Measles, Mumps, Rubella, Erythema infectiosum, HFMD, Roseola infantum, Chickenpox
---
...
- **D:** caused by an RNA paramyxovirus. Spread by aerosol transmission, very infectious. Incubation 10–14 days. Patient is infective from the prodrome until 4 days after the rash starts.
- **S/Smx:**
  - Prodromal phase: irritable, fever, conjunctivitis.
  - Koplik spots — white spots ("grains of salt") on the buccal mucosa, typically developing before the rash.
  - Rash — starts on the head then spreads to the whole body; discrete maculopapular rash becoming blotchy and confluent; desquamation may occur after a week, sparing palms and soles.
  - Diarrhoea in 10%.
...
- **Complications:** otitis media (most common); pneumonia (most common cause of death); encephalitis (typically 1–2 weeks after onset); subacute sclerosing panencephalitis (see 08.05 for more); febrile convulsions; keratoconjunctivitis, corneal ulceration; diarrhoea; increased incidence of appendicitis; myocarditis.
- If an unimmunised child contacts measles, offer MMR — vaccine-induced antibodies develop more rapidly than natural infection; give within 72h.

## Mumps

- RNA paramyxovirus, spread by droplets.
- **MOA:** spreads to respiratory tract epithelial cells, to the parotid glands, to other tissues.
...
*(Complications — see 08.05.)*

## Rubella (German measles)

- Togavirus; winter and spring predominance. Incubation 14–21 days; infectious 7 days before symptoms appear to 4 days after the rash starts.
- **S/Smx:** prodrome of fever; rash — maculopapular, face to whole body, fades after 3–5 days; lymphadenopathy — suboccipital and postauricular.
- **Mx:** supportive. Notify public health. Immunisation is a live virus vaccine.

*(See [[08_05-06_Infectious_Disease_-_Viral_Infections]] Rubella (German measles) — including the congenital rubella syndrome danger box within that entry — for more detail, not repeated here.)*

## Erythema infectiosum (slapped cheek syndrome)

- Caused by Parvovirus B19. Spread by droplets. Patient is infectious 3–5 days before the rash appears.
...
- Intestinal viruses coxsackie A16 and enterovirus 71.
- **S/Smx:** oral ulcers; sore throat, fever; vesicles on palms and soles.
- **Mx:** symptomatic — analgesia and hydration. No need to exclude children from school unless they feel unwell. Reassure that it is not linked to cattle disease.
...
- **R:** exposure, age 1–9, unimmunised status, occupational exposure.
- **A/P:** direct contact or airborne respiratory droplet spread → virus spreads to regional lymph nodes causing a primary viraemic phase → spreads to liver, spleen, etc. Secondary viraemic phase at ~day 9 — mononuclear cells transport the virus to the skin and mucous membranes → classic vesicular rash. Patients are infectious 2–4 days before onset of rash, and remain so until lesions are crusted over. Incubation ~14 days.
- **Features:** fever initially ± mild systemic upset. Rash: itchy, starts on head/trunk (macular → papular → vesicular). Severe disease is associated with complications such as pneumonia, neurological sequelae, hepatitis, secondary bacterial infection.
- **Mx:** supportive — keep cool, trim nails, calamine lotion. School exclusion until lesions have crusted over.
