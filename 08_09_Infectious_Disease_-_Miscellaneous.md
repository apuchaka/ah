...
- **Mx:** clean wound, do not suture closed unless thorough washout performed. Antibiotics: co-amoxiclav, or doxycycline + metronidazole — **adult regimens; see the paediatric note below**.

> [!warning] **Bites are a common paediatric presentation, and this entry gives only adult doses — and two adult drug *choices* that are not simply scaled down for a child.**
> **Doses:** amoxicillin-clavulanate in children is dosed **per kilogram**, not at the adult 875/125mg figure below.
> **Drug choice, which matters more than the dose here:** **doxycycline** is traditionally avoided in younger children (dental staining) and **ciprofloxacin** is generally not a routine paediatric choice — so both penicillin-allergy alternatives given below are adult answers. A child with a penicillin allergy and a bite needs the paediatric alternative from eTG or the Royal Children's Hospital guideline, **not** the adult second-line regimen read across.
> Note the box below already says prophylaxis is not needed for all bites **"in adults"** — it recognised the adult framing without supplying the paediatric counterpart. The box also cites **RCH Clinical Practice Guidelines** as a source, so the paediatric guidance is available in a source already used here. Found by the corpus-wide adult-vs-paediatric sweep, 2026-08-30; see `PENDING_GUIDELINE_CHECKS.md` **B70**.
...
> **The prophylaxis doses above are ADULT doses.** The duration line below extends the regimen to children explicitly — but no paediatric dose is given, and penicillin and amoxicillin prophylaxis in children is dosed **by weight or by age band**, not at the adult figure. **Take the paediatric dose from eTG or the local paediatric protocol.** The mismatch matters here more than in most entries, because the group at the highest risk of overwhelming post-splenectomy infection is **young children** — the very group the doses do not cover. Found by the corpus-wide adult-vs-paediatric sweep, 2026-08-30; see `PENDING_GUIDELINE_CHECKS.md` **B69**.
