...
| B24 | `11_09b_Ortho_-_Trauma.md` | Burns and Scalds | ANZBA's Emergency Management of Severe Burns manual and the primary ANZBA referral-criteria PDF were both **egress-blocked**; content is from ANZCOR 9.1.3 plus search snippets of ANZBA material. Highest-risk elements: the **Parkland figure (3–4 mL/kg/%TBSA)**, which varies between 3 and 4 across state guidelines, and the **paediatric Rule of Nines percentages** (head ~18%), which are stated approximately and should be replaced by a Lund and Browder chart in practice. | ⬜ |
...
| Burns and Scalds | `11_09b_…` | ANZBA manual + referral PDF (blocked) | Parkland 3–4 mL figure; paediatric Rule of Nines percentages |
